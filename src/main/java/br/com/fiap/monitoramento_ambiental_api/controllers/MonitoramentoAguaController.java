...
public class MonitoramentoAguaController {
    ...
    @GetMapping("/{id}")
    public MonitoramentoAgua buscarPorId(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public MonitoramentoAgua atualizar(@PathVariable Long id, @RequestBody MonitoramentoAgua monitoramentoAgua) {
