...
public class MonitoramentoArController {
    ...
    @GetMapping("/{id}")
    public MonitoramentoArDTO buscarPorId(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public MonitoramentoArDTO atualizar(@PathVariable Long id, @RequestBody @Valid MonitoramentoArDTO monitoramentoArDTO) {
        MonitoramentoAr monitoramentoAr = convertToEntity(monitoramentoArDTO);
